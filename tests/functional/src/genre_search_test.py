...
@pytest.mark.asyncio
async def test_search_genres_by_name(make_get_request):
    await make_get_request('/genres?query=Genre 1')


@pytest.mark.asyncio
async def test_search_genres_by_wrong_name(make_get_request):
    await make_get_request('/genres?query=asd')


@pytest.mark.asyncio
async def test_search_genres_with_size_1(make_get_request):
...
@pytest.mark.asyncio
async def test_search_genres_with_size_2(make_get_request):
...
@pytest.mark.asyncio
async def test_search_genres_with_size_1_and_from_1(make_get_request):
...
@pytest.mark.asyncio
async def test_search_genres_with_size_1_and_from_2(make_get_request):
...
@pytest.mark.asyncio
async def test_search_genres_with_size_1_and_from_3(make_get_request):
...
@pytest.mark.asyncio
async def test_search_genres_with_size_2_and_from_1(make_get_request):
...
@pytest.mark.asyncio
async def test_search_genres_with_size_2_and_from_2(make_get_request):
...
@pytest.mark.asyncio
async def test_search_genres_with_size_2_and_from_3(make_get_request):
